      ...
      >
        <rect
          ...
          className={cn(
            ...
            // focus
            'group-focus/checkbox:fill-green-600',
            // disabled
            'group-disabled/checkbox:fill-bg-soft-200',
            // hover
            'group-hover/checkbox:group-data-[state=checked]/checkbox:fill-green-600',
            'group-hover/checkbox:group-data-[state=indeterminate]/checkbox:fill-green-600',
            // focus
            'group-focus/checkbox:group-data-[state=checked]/checkbox:fill-green-600',
            'group-focus/checkbox:group-data-[state=indeterminate]/checkbox:fill-green-600',
            // checked
            'group-data-[state=checked]/checkbox:fill-green-600',
            'group-data-[state=indeterminate]/checkbox:fill-green-600',
            // disabled checked
