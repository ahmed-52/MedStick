...
export const selectVariants = tv({
  slots: {
    triggerRoot: [
      // base
      "group/trigger min-w-0 shrink-0 bg-bg-white-0 shadow-custom-input outline-none",
      "text-sm font-medium text-text-sub-600 cursor-pointer",
      "flex items-center text-left",
      "transition-all duration-200 ease-out",
      // hover
      "hover:bg-bg-weak-50 hover:shadow-gray-shadow hover:text-text-sub-600",
      // open state - remove !important to allow transitions
      '[data-state="open"]:shadow-complex-3 [data-state="open"]:text-text-sub-600',
      "data-[state=open]:shadow-complex-3 data-[state=open]:text-text-sub-600",
      // additional selectors for better targeting - without !important
      "group-data-[state=open]/trigger:shadow-complex-3 group-data-[state=open]/trigger:text-text-sub-600",
      // open hover (maintain open styles) - without !important
      '[data-state="open"]:hover:shadow-complex-3 [data-state="open"]:hover:text-text-sub-600',
      "data-[state=open]:hover:shadow-complex-3 data-[state=open]:hover:text-text-sub-600",
      "group-data-[state=open]/trigger:hover:shadow-complex-3 group-data-[state=open]/trigger:hover:text-text-sub-600",
      // disabled
    ...
    triggerArrow: [
      ...
      // open state - remove !important to allow transitions
      "data-[state=open]:text-green-600 data-[state=open]:-rotate-180",
      // additional selectors for better targeting - without !important
      "group-data-[state=open]/trigger:text-green-600 group-data-[state=open]/trigger:-rotate-180",
      // open hover (maintain open styles) - without !important
      '[data-state="open"]:group-hover:text-green-600 [data-state="open"]:group-hover:-rotate-180',
      "data-[state=open]:group-hover:text-green-600 data-[state=open]:group-hover:-rotate-180",
      "group-data-[state=open]/trigger:group-hover:text-green-600 group-data-[state=open]/trigger:group-hover:-rotate-180",
      // disabled
    ...
    triggerIcon: [
      ...
      "data-[state=open]:text-green-600",
      // additional selectors for better targeting - without !important
      "group-data-[state=open]/trigger:text-green-600",
      // open hover (maintain open styles) - without !important
      '[data-state="open"]:group-hover:text-green-600',
      "data-[state=open]:group-hover:text-green-600",
      "group-data-[state=open]/trigger:group-hover:text-green-600",
      // disabled
      "group-disabled/trigger:text-text-disabled-300",
  ...
  variants: {
    ...
    variant: {
      ...
      compactForInput: {
        triggerRoot: [
          // base
          "w-auto rounded-none shadow-custom-input ring-0",
          // focus
          "focus:bg-bg-weak-50 focus:shadow-gray-shadow focus:ring-0 focus:ring-transparent",
        ],
      },
      inline: {
        triggerRoot: [
          // base
          "h-5 min-h-5 w-auto gap-0 rounded-none bg-transparent p-0 text-text-sub-600 shadow-custom-input ring-0",
          // hover
          "hover:bg-bg-weak-50 hover:text-text-sub-600 hover:shadow-gray-shadow",
          // focus
          "focus:shadow-complex-3",
          // open
          "data-[state=open]:text-text-sub-600 data-[state=open]:shadow-complex-3",
        ],
        triggerIcon: [
          // base
          ...
          // open
          "group-data-[state=open]/trigger:text-green-600 group-data-[state=open]/trigger:shadow-complex-3",
        ],
        triggerArrow: [
          // base
          "ml-0.5",
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      variant: "default",
      class: {
        triggerRoot: "h-8 min-h-8 gap-1 rounded-10 pl-3 pr-2",
      },
    },
    //#endregion
  ...
  (
    ...
    <SelectPrimitives.Portal>
      <SelectPrimitives.Content
        ...
        className={cn(
          // base
          "bg-bg-white-0 shadow-gray-shadow relative z-50 overflow-hidden rounded-2xl",
          // widths
...
>(({ className, children, ...rest }, forwardedRef) => {
  ...
  return (
    <SelectPrimitives.Item
      ...
      className={cn(
        // base
        "group text-text-strong-950 relative cursor-pointer rounded-lg p-2 pr-9 text-sm font-medium select-none",
