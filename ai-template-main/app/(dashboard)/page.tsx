...
export default function DashboardHome() {
  return (
    <div className="flex h-full flex-col lg:p-1.5 lg:pl-0">
      <div className="bg-bg-white-0 lg:border-stroke-soft-200 relative flex h-full flex-col justify-between pb-4 lg:justify-end lg:rounded-3xl lg:border lg:py-4 lg:pr-4 lg:pl-5">
        ...
        <div className="absolute top-1/2 left-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center px-4">
          <div className="mb-5">
            <Logo className="text-text-disabled-300 size-8" />
          </div>
          <div className="tracking-spacing-tiny-1 text-text-strong-950 mb-1 text-lg/snug font-medium">
            Hello James
          </div>
          <div className="tracking-spacing-tiny-2 text-text-soft-400 text-center text-sm font-medium">
