        ...
        <SwitchPrimitives.Thumb
          className={cn(
            ...
            !disabled && [
              ...
              "before:[-webkit-mask:var(--mask)] before:[mask:var(--mask)]",
              // after
          ...
          style={{
            ["--mask" as any]:
              "radial-gradient(circle farthest-side at 50% 50%, transparent 1.95px, black 2.05px 100%) 50% 50%/100% 100% no-repeat",
          }}
        />
      </div>
    </SwitchPrimitives.Root>
